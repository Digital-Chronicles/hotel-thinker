...
urlpatterns = [
    ...
    path("hotels/<slug:slug>/rooms/<int:pk>/", views.PublicHotelRoomDetailAPIView.as_view(), name="hotel_room_detail"),
    ...
    path("hotels/<slug:slug>/menu/categories/", views.PublicMenuCategoryListAPIView.as_view(), name="menu_categories"),
    path("hotels/<slug:slug>/menu/items/", views.PublicMenuItemListAPIView.as_view(), name="menu_items"),
    path("hotels/<slug:slug>/menu/items/<int:pk>/", views.PublicMenuItemDetailAPIView.as_view(), name="menu_item_detail"),
    path("hotels/<slug:slug>/bar/", views.PublicBarAPIView.as_view(), name="bar"),
    path("hotels/<slug:slug>/bar/categories/", views.PublicBarCategoryListAPIView.as_view(), name="bar_categories"),
    path("hotels/<slug:slug>/bar/items/", views.PublicBarItemListAPIView.as_view(), name="bar_items"),
    path("hotels/<slug:slug>/bar/items/<int:pk>/", views.PublicBarItemDetailAPIView.as_view(), name="bar_item_detail"),
