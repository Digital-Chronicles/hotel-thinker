...
urlpatterns = [
    ...
    path("api/available-rooms/", views.get_available_rooms_api, name="api_available_rooms"),
    path("api/room-price/", views.get_room_price_api, name="api_room_price"),
    path("api/stats/", views.booking_stats_api, name="booking_stats_api"),
    path("api/quick-stats/", views.booking_quick_stats_api, name="booking_quick_stats_api"),
]